...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      54:	b90080e7          	jalr	-1136(ra) # 5be0 <exit>
      ...
      74:	8082                	ret
{
      ...
      96:	b4e080e7          	jalr	-1202(ra) # 5be0 <exit>
...
000000000000009a <opentest>:
{
  ...
  if(fd >= 0){
    ...
    exit(1);
      ...
      fc:	ae8080e7          	jalr	-1304(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     118:	acc080e7          	jalr	-1332(ra) # 5be0 <exit>
...
000000000000011c <truncate2>:
{
  ...
  close(fd2);
    ...
    exit(1);
     ...
     1e0:	a04080e7          	jalr	-1532(ra) # 5be0 <exit>
...
0000000000000264 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     328:	8bc080e7          	jalr	-1860(ra) # 5be0 <exit>
     32c:	84ce                	mv	s1,s3
      int cc = write(fd, buf, sz);
     32e:	89aa                	mv	s3,a0
     ...
     34c:	898080e7          	jalr	-1896(ra) # 5be0 <exit>
...
badwrite(char *s)
{
  ...
  if(write(fd, "x", 1) != 1){
    ...
    exit(1);
     ...
     404:	7e0080e7          	jalr	2016(ra) # 5be0 <exit>
      printf("open junk failed\n");
     ...
     41e:	7c6080e7          	jalr	1990(ra) # 5be0 <exit>
    printf("open junk failed\n");
    ...
    exit(1);
     ...
     438:	7ac080e7          	jalr	1964(ra) # 5be0 <exit>
  }
  close(fd);
     43c:	8526                	mv	a0,s1
  ...
  exit(0);
     ...
     45c:	788080e7          	jalr	1928(ra) # 5be0 <exit>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     614:	5d0080e7          	jalr	1488(ra) # 5be0 <exit>
     ...
     632:	5b2080e7          	jalr	1458(ra) # 5be0 <exit>
     ...
     650:	594080e7          	jalr	1428(ra) # 5be0 <exit>
      printf("pipe() failed\n");
     ...
     66a:	57a080e7          	jalr	1402(ra) # 5be0 <exit>
     ...
     688:	55c080e7          	jalr	1372(ra) # 5be0 <exit>
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     774:	470080e7          	jalr	1136(ra) # 5be0 <exit>
     ...
     792:	452080e7          	jalr	1106(ra) # 5be0 <exit>
      printf("pipe() failed\n");
     ...
     7ac:	438080e7          	jalr	1080(ra) # 5be0 <exit>
     ...
     7c6:	41e080e7          	jalr	1054(ra) # 5be0 <exit>
     ...
     7e4:	400080e7          	jalr	1024(ra) # 5be0 <exit>
...
00000000000007e8 <truncate1>:
{
  ...
  close(fd3);
    ...
    exit(1);
     ...
     95a:	28a080e7          	jalr	650(ra) # 5be0 <exit>
    printf("aaa fd3=%d\n", fd3);
     95e:	85ca                	mv	a1,s2
    ...
    exit(1);
     ...
     98a:	25a080e7          	jalr	602(ra) # 5be0 <exit>
    printf("bbb fd2=%d\n", fd2);
     98e:	85a6                	mv	a1,s1
    ...
    exit(1);
     ...
     9ba:	22a080e7          	jalr	554(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     9d8:	20c080e7          	jalr	524(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     9f6:	1ee080e7          	jalr	494(ra) # 5be0 <exit>
...
00000000000009fa <writetest>:
{
  ...
  if(unlink("small") < 0){
    ...
    exit(1);
     ...
     af6:	0ee080e7          	jalr	238(ra) # 5be0 <exit>
     ...
     b14:	0d0080e7          	jalr	208(ra) # 5be0 <exit>
     ...
     b32:	0b2080e7          	jalr	178(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     b4e:	096080e7          	jalr	150(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     b6a:	07a080e7          	jalr	122(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     b86:	05e080e7          	jalr	94(ra) # 5be0 <exit>
...
0000000000000b8a <writebig>:
{
  ...
  if(fd < 0){
    ...
    exit(1);
     ...
     c52:	f92080e7          	jalr	-110(ra) # 5be0 <exit>
     ...
     c70:	f74080e7          	jalr	-140(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     c8c:	f58080e7          	jalr	-168(ra) # 5be0 <exit>
      if(n == MAXFILE - 1){
  ...
  if(unlink("big") < 0){
     ...
     ce4:	f00080e7          	jalr	-256(ra) # 5be0 <exit>
     ...
     d02:	ee2080e7          	jalr	-286(ra) # 5be0 <exit>
     ...
     d20:	ec4080e7          	jalr	-316(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     d3c:	ea8080e7          	jalr	-344(ra) # 5be0 <exit>
...
0000000000000d40 <unlinkread>:
{
  ...
  unlink("unlinkread");
    ...
    exit(1);
     ...
     e66:	d7e080e7          	jalr	-642(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     e82:	d62080e7          	jalr	-670(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     e9e:	d46080e7          	jalr	-698(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     eba:	d2a080e7          	jalr	-726(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     ed6:	d0e080e7          	jalr	-754(ra) # 5be0 <exit>
    ...
    exit(1);
     ...
     ef2:	cf2080e7          	jalr	-782(ra) # 5be0 <exit>
...
0000000000000ef6 <linktest>:
{
  ...
  if(link(".", "lf1") >= 0){
    ...
    105e:	b86080e7          	jalr	-1146(ra) # 5be0 <exit>
    ...
    107a:	b6a080e7          	jalr	-1174(ra) # 5be0 <exit>
    ...
    1096:	b4e080e7          	jalr	-1202(ra) # 5be0 <exit>
    ...
    10b2:	b32080e7          	jalr	-1230(ra) # 5be0 <exit>
    ...
    10ce:	b16080e7          	jalr	-1258(ra) # 5be0 <exit>
    ...
    10ea:	afa080e7          	jalr	-1286(ra) # 5be0 <exit>
    ...
    1106:	ade080e7          	jalr	-1314(ra) # 5be0 <exit>
    ...
    1122:	ac2080e7          	jalr	-1342(ra) # 5be0 <exit>
    ...
    113e:	aa6080e7          	jalr	-1370(ra) # 5be0 <exit>
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    11ac:	a38080e7          	jalr	-1480(ra) # 5be0 <exit>
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    12d4:	910080e7          	jalr	-1776(ra) # 5be0 <exit>
    ...
    12f4:	8f0080e7          	jalr	-1808(ra) # 5be0 <exit>
    ...
    1310:	8d4080e7          	jalr	-1836(ra) # 5be0 <exit>
...
0000000000001314 <pgbug>:
{
  ...
  exit(0);
    ...
    1348:	89c080e7          	jalr	-1892(ra) # 5be0 <exit>
...
000000000000134c <badarg>:
{
  ...
  exit(0);
    ...
    138e:	856080e7          	jalr	-1962(ra) # 5be0 <exit>
...
0000000000001392 <copyinstr2>:
{
  ...
  int pid = fork();
    ...
    141a:	7c2080e7          	jalr	1986(ra) # 5bd8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    149e:	746080e7          	jalr	1862(ra) # 5be0 <exit>
    ...
    14be:	726080e7          	jalr	1830(ra) # 5be0 <exit>
    ...
    14de:	706080e7          	jalr	1798(ra) # 5be0 <exit>
    ...
    1500:	6e4080e7          	jalr	1764(ra) # 5be0 <exit>
    ...
    1520:	6c4080e7          	jalr	1732(ra) # 5be0 <exit>
    printf("fork failed\n");
  ...
  if(st != 747){
    ...
    1584:	660080e7          	jalr	1632(ra) # 5be0 <exit>
...
0000000000001588 <truncate3>:
{
  ...
  pid = fork();
    ...
    15bc:	620080e7          	jalr	1568(ra) # 5bd8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    163c:	5a8080e7          	jalr	1448(ra) # 5be0 <exit>
    ...
    1658:	58c080e7          	jalr	1420(ra) # 5be0 <exit>
    ...
    1674:	570080e7          	jalr	1392(ra) # 5be0 <exit>
    ...
    1692:	552080e7          	jalr	1362(ra) # 5be0 <exit>
  ...
  wait(&xstatus);
    ...
    16e8:	504080e7          	jalr	1284(ra) # 5be8 <wait>
  unlink("truncfile");
  ...
  exit(xstatus);
    ...
    1704:	4e0080e7          	jalr	1248(ra) # 5be0 <exit>
      printf("%s: open failed\n", s);
    1708:	85ca                	mv	a1,s2
    ...
    1720:	4c4080e7          	jalr	1220(ra) # 5be0 <exit>
    ...
    173e:	4a6080e7          	jalr	1190(ra) # 5be0 <exit>
...
0000000000001742 <exectest>:
{
  ...
  pid = fork();
    ...
    1780:	45c080e7          	jalr	1116(ra) # 5bd8 <fork>
  if(pid < 0) {
  ...
  if(pid == 0) {
    ...
    17cc:	418080e7          	jalr	1048(ra) # 5be0 <exit>
     printf("%s: fork failed\n", s);
    17d0:	85ca                	mv	a1,s2
    ...
    17e8:	3fc080e7          	jalr	1020(ra) # 5be0 <exit>
    ...
    1804:	3e0080e7          	jalr	992(ra) # 5be0 <exit>
  ...
  if (wait(&xstatus) != pid) {
    ...
    1828:	3c4080e7          	jalr	964(ra) # 5be8 <wait>
  ...
  if(xstatus != 0)
    ...
    183a:	3aa080e7          	jalr	938(ra) # 5be0 <exit>
    ...
    1856:	38e080e7          	jalr	910(ra) # 5be0 <exit>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    18b0:	334080e7          	jalr	820(ra) # 5be0 <exit>
    printf("%s: open failed\n", s);
    18b4:	85ca                	mv	a1,s2
    ...
    18cc:	318080e7          	jalr	792(ra) # 5be0 <exit>
  unlink("echo-ok");
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1910:	2d4080e7          	jalr	724(ra) # 5be0 <exit>
    exit(0);
    1914:	4501                	li	a0,0
    1916:	00004097          	auipc	ra,0x4
    191a:	2ca080e7          	jalr	714(ra) # 5be0 <exit>
...
000000000000191e <pipe1>:
{
  ...
  pid = fork();
    ...
    194a:	292080e7          	jalr	658(ra) # 5bd8 <fork>
    194e:	8a2a                	mv	s4,a0
  if(pid == 0){
    ...
    19d2:	212080e7          	jalr	530(ra) # 5be0 <exit>
    close(fds[0]);
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a3c:	1a8080e7          	jalr	424(ra) # 5be0 <exit>
    ...
    1a58:	18c080e7          	jalr	396(ra) # 5be0 <exit>
    ...
    1aa6:	13e080e7          	jalr	318(ra) # 5be0 <exit>
    close(fds[0]);
    ...
    1abe:	12e080e7          	jalr	302(ra) # 5be8 <wait>
    exit(xstatus);
    1ac2:	fa442503          	lw	a0,-92(s0)
    1ac6:	00004097          	auipc	ra,0x4
    1aca:	11a080e7          	jalr	282(ra) # 5be0 <exit>
    printf("%s: fork() failed\n", s);
    1ace:	85ca                	mv	a1,s2
    ...
    1ae6:	0fe080e7          	jalr	254(ra) # 5be0 <exit>
...
0000000000001aea <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b06:	0d6080e7          	jalr	214(ra) # 5bd8 <fork>
    1b0a:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    1b1a:	0d2080e7          	jalr	210(ra) # 5be8 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b58:	08c080e7          	jalr	140(ra) # 5be0 <exit>
    ...
    1b74:	070080e7          	jalr	112(ra) # 5be0 <exit>
    ...
    1b90:	054080e7          	jalr	84(ra) # 5be0 <exit>
      exit(i);
    1b94:	854a                	mv	a0,s2
    1b96:	00004097          	auipc	ra,0x4
    1b9a:	04a080e7          	jalr	74(ra) # 5be0 <exit>
...
0000000000001b9e <twochildren>:
{
    ...
    1bb4:	028080e7          	jalr	40(ra) # 5bd8 <fork>
    if(pid1 < 0){
    ...
    1bc2:	01a080e7          	jalr	26(ra) # 5bd8 <fork>
      if(pid2 < 0){
    ...
    1bd2:	01a080e7          	jalr	26(ra) # 5be8 <wait>
        wait(0);
    1bd6:	4501                	li	a0,0
    1bd8:	00004097          	auipc	ra,0x4
    1bdc:	010080e7          	jalr	16(ra) # 5be8 <wait>
  for(int i = 0; i < 1000; i++){
    ...
    1c08:	fdc080e7          	jalr	-36(ra) # 5be0 <exit>
      exit(0);
    1c0c:	00004097          	auipc	ra,0x4
    1c10:	fd4080e7          	jalr	-44(ra) # 5be0 <exit>
        printf("%s: fork failed\n", s);
    1c14:	85ca                	mv	a1,s2
    ...
    1c2c:	fb8080e7          	jalr	-72(ra) # 5be0 <exit>
        exit(0);
    1c30:	00004097          	auipc	ra,0x4
    1c34:	fb0080e7          	jalr	-80(ra) # 5be0 <exit>
...
0000000000001c38 <forkfork>:
{
    ...
    1c48:	f94080e7          	jalr	-108(ra) # 5bd8 <fork>
    if(pid < 0){
    ...
    1c56:	f86080e7          	jalr	-122(ra) # 5bd8 <fork>
    if(pid < 0){
    ...
    1c68:	f84080e7          	jalr	-124(ra) # 5be8 <wait>
    if(xstatus != 0) {
    ...
    1c7a:	f72080e7          	jalr	-142(ra) # 5be8 <wait>
    if(xstatus != 0) {
    ...
    1ca6:	f3e080e7          	jalr	-194(ra) # 5be0 <exit>
{
    1caa:	0c800493          	li	s1,200
        int pid1 = fork();
    1cae:	00004097          	auipc	ra,0x4
    1cb2:	f2a080e7          	jalr	-214(ra) # 5bd8 <fork>
        if(pid1 < 0){
    ...
    1cc2:	f2a080e7          	jalr	-214(ra) # 5be8 <wait>
      for(int j = 0; j < 200; j++){
    ...
    1cd0:	f14080e7          	jalr	-236(ra) # 5be0 <exit>
          exit(1);
    1cd4:	4505                	li	a0,1
    1cd6:	00004097          	auipc	ra,0x4
    1cda:	f0a080e7          	jalr	-246(ra) # 5be0 <exit>
          exit(0);
    1cde:	00004097          	auipc	ra,0x4
    1ce2:	f02080e7          	jalr	-254(ra) # 5be0 <exit>
    ...
    1cfe:	ee6080e7          	jalr	-282(ra) # 5be0 <exit>
...
0000000000001d02 <reparent2>:
{
    ...
    1d14:	ec8080e7          	jalr	-312(ra) # 5bd8 <fork>
    if(pid1 < 0){
    ...
    1d24:	ec8080e7          	jalr	-312(ra) # 5be8 <wait>
  for(int i = 0; i < 800; i++){
  ...
  exit(0);
    ...
    1d32:	eb2080e7          	jalr	-334(ra) # 5be0 <exit>
      printf("fork failed\n");
    ...
    1d4c:	e98080e7          	jalr	-360(ra) # 5be0 <exit>
      fork();
    1d50:	00004097          	auipc	ra,0x4
    1d54:	e88080e7          	jalr	-376(ra) # 5bd8 <fork>
      fork();
    1d58:	00004097          	auipc	ra,0x4
    1d5c:	e80080e7          	jalr	-384(ra) # 5bd8 <fork>
      exit(0);
    1d60:	4501                	li	a0,0
    1d62:	00004097          	auipc	ra,0x4
    1d66:	e7e080e7          	jalr	-386(ra) # 5be0 <exit>
...
0000000000001d6a <createdelete>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1d8e:	e4e080e7          	jalr	-434(ra) # 5bd8 <fork>
    1d92:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1daa:	e42080e7          	jalr	-446(ra) # 5be8 <wait>
    if(xstatus != 0)
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dea:	dfa080e7          	jalr	-518(ra) # 5be0 <exit>
      name[0] = 'p' + pi;
    ...
    1e16:	dce080e7          	jalr	-562(ra) # 5be0 <exit>
      for(i = 0; i < N; i++){
    ...
    1e88:	d5c080e7          	jalr	-676(ra) # 5be0 <exit>
      exit(0);
    1e8c:	4501                	li	a0,0
    1e8e:	00004097          	auipc	ra,0x4
    1e92:	d52080e7          	jalr	-686(ra) # 5be0 <exit>
      exit(1);
    1e96:	4505                	li	a0,1
    1e98:	00004097          	auipc	ra,0x4
    1e9c:	d48080e7          	jalr	-696(ra) # 5be0 <exit>
    ...
    1ebc:	d28080e7          	jalr	-728(ra) # 5be0 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1f22:	cc2080e7          	jalr	-830(ra) # 5be0 <exit>
  for(i = 0; i < N; i++){
...
0000000000001f90 <linkunlink>:
{
  ...
  pid = fork();
    ...
    1fc0:	c1c080e7          	jalr	-996(ra) # 5bd8 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2012:	bd2080e7          	jalr	-1070(ra) # 5be0 <exit>
  ...
  if(pid)
    ...
    206a:	b82080e7          	jalr	-1150(ra) # 5be8 <wait>
}
    ...
    208e:	b56080e7          	jalr	-1194(ra) # 5be0 <exit>
...
0000000000002092 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20ac:	b30080e7          	jalr	-1232(ra) # 5bd8 <fork>
    if(pid < 0)
  ...
  for(n=0; n<N; n++){
    ...
    20d4:	b10080e7          	jalr	-1264(ra) # 5be0 <exit>
      exit(0);
    20d8:	00004097          	auipc	ra,0x4
    20dc:	b08080e7          	jalr	-1272(ra) # 5be0 <exit>
  if (n == 0) {
  ...
  for(; n > 0; n--){
    ...
    20f4:	af8080e7          	jalr	-1288(ra) # 5be8 <wait>
  ...
  if(wait(0) != -1){
    ...
    2106:	ae6080e7          	jalr	-1306(ra) # 5be8 <wait>
    210a:	57fd                	li	a5,-1
    ...
    2136:	aae080e7          	jalr	-1362(ra) # 5be0 <exit>
    ...
    2152:	a92080e7          	jalr	-1390(ra) # 5be0 <exit>
    ...
    216e:	a76080e7          	jalr	-1418(ra) # 5be0 <exit>
...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21a0:	a3c080e7          	jalr	-1476(ra) # 5bd8 <fork>
    if(pid < 0){
    ...
    21b2:	a3a080e7          	jalr	-1478(ra) # 5be8 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21ee:	9f6080e7          	jalr	-1546(ra) # 5be0 <exit>
    ...
    2210:	9d4080e7          	jalr	-1580(ra) # 5be0 <exit>
      exit(1);
    2214:	4505                	li	a0,1
    2216:	00004097          	auipc	ra,0x4
    221a:	9ca080e7          	jalr	-1590(ra) # 5be0 <exit>
...
000000000000221e <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2240:	99c080e7          	jalr	-1636(ra) # 5bd8 <fork>
    if(pid < 0){
    ...
    2252:	99a080e7          	jalr	-1638(ra) # 5be8 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for( ; a != 0; a <<= 1){
    ...
    2292:	952080e7          	jalr	-1710(ra) # 5be0 <exit>
      *(char*)a = 99;
    ...
    22be:	926080e7          	jalr	-1754(ra) # 5be0 <exit>
      exit(1);
    22c2:	4505                	li	a0,1
    22c4:	00004097          	auipc	ra,0x4
    22c8:	91c080e7          	jalr	-1764(ra) # 5be0 <exit>
...
00000000000022cc <bigargtest>:
{
  ...
  pid = fork();
    ...
    22ec:	8f0080e7          	jalr	-1808(ra) # 5bd8 <fork>
  if(pid == 0){
  ...
  wait(&xstatus);
    ...
    22fe:	8ee080e7          	jalr	-1810(ra) # 5be8 <wait>
  if(xstatus != 0)
  ...
  close(fd);
    ...
    238e:	856080e7          	jalr	-1962(ra) # 5be0 <exit>
    ...
    23aa:	83a080e7          	jalr	-1990(ra) # 5be0 <exit>
    exit(xstatus);
    23ae:	00004097          	auipc	ra,0x4
    23b2:	832080e7          	jalr	-1998(ra) # 5be0 <exit>
    ...
    23ce:	816080e7          	jalr	-2026(ra) # 5be0 <exit>
...
00000000000023d2 <stacktest>:
{
  ...
  pid = fork();
    ...
    23e2:	7fa080e7          	jalr	2042(ra) # 5bd8 <fork>
  if(pid == 0) {
  ...
  wait(&xstatus);
    ...
    23f4:	7f8080e7          	jalr	2040(ra) # 5be8 <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    2406:	7de080e7          	jalr	2014(ra) # 5be0 <exit>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    242c:	7b8080e7          	jalr	1976(ra) # 5be0 <exit>
    printf("%s: fork failed\n", s);
    2430:	85a6                	mv	a1,s1
    ...
    2448:	79c080e7          	jalr	1948(ra) # 5be0 <exit>
    exit(0);
    244c:	4501                	li	a0,0
    244e:	00003097          	auipc	ra,0x3
    2452:	792080e7          	jalr	1938(ra) # 5be0 <exit>
...
0000000000002456 <textwrite>:
{
  ...
  pid = fork();
    ...
    2466:	776080e7          	jalr	1910(ra) # 5bd8 <fork>
  if(pid == 0) {
  ...
  wait(&xstatus);
    ...
    2478:	774080e7          	jalr	1908(ra) # 5be8 <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    248a:	75a080e7          	jalr	1882(ra) # 5be0 <exit>
    *addr = 10;
    248e:	47a9                	li	a5,10
    ...
    249a:	74a080e7          	jalr	1866(ra) # 5be0 <exit>
    printf("%s: fork failed\n", s);
    249e:	85a6                	mv	a1,s1
    ...
    24b6:	72e080e7          	jalr	1838(ra) # 5be0 <exit>
    exit(0);
    24ba:	4501                	li	a0,0
    24bc:	00003097          	auipc	ra,0x3
    24c0:	724080e7          	jalr	1828(ra) # 5be0 <exit>
...
00000000000024c4 <manywrites>:
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    24e4:	6f8080e7          	jalr	1784(ra) # 5bd8 <fork>
    24e8:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    2504:	6e8080e7          	jalr	1768(ra) # 5be8 <wait>
    if(st != 0)
  ...
  exit(0);
    ...
    2518:	6cc080e7          	jalr	1740(ra) # 5be0 <exit>
      printf("fork failed\n");
    ...
    2532:	6b2080e7          	jalr	1714(ra) # 5be0 <exit>
      name[0] = 'b';
    ...
    25c2:	622080e7          	jalr	1570(ra) # 5be0 <exit>
    ...
    25e2:	602080e7          	jalr	1538(ra) # 5be0 <exit>
            printf("%s: write(%d) ret %d\n", s, sz, cc);
    25e6:	86aa                	mv	a3,a0
    ...
    2602:	5e2080e7          	jalr	1506(ra) # 5be0 <exit>
      exit(st);
    2606:	00003097          	auipc	ra,0x3
    260a:	5da080e7          	jalr	1498(ra) # 5be0 <exit>
...
000000000000260e <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    26dc:	508080e7          	jalr	1288(ra) # 5be0 <exit>
    printf("unlink(%s) returned %d, not -1\n", b, ret);
    26e0:	862a                	mv	a2,a0
    26e2:	85a6                	mv	a1,s1
    ...
    26fa:	4ea080e7          	jalr	1258(ra) # 5be0 <exit>
    printf("open(%s) returned %d, not -1\n", b, fd);
    26fe:	862a                	mv	a2,a0
    2700:	85a6                	mv	a1,s1
    ...
    2718:	4cc080e7          	jalr	1228(ra) # 5be0 <exit>
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
    271c:	86aa                	mv	a3,a0
    271e:	8626                	mv	a2,s1
    2720:	85a6                	mv	a1,s1
    ...
    2738:	4ac080e7          	jalr	1196(ra) # 5be0 <exit>
    printf("exec(%s) returned %d, not -1\n", b, fd);
    273c:	567d                	li	a2,-1
    273e:	85a6                	mv	a1,s1
    ...
    2756:	48e080e7          	jalr	1166(ra) # 5be0 <exit>
...
000000000000275a <rwsbrk>:
{
  ...
  if(n >= 0){
    ...
    27d4:	410080e7          	jalr	1040(ra) # 5be0 <exit>
    ...
    27ee:	3f6080e7          	jalr	1014(ra) # 5be0 <exit>
    ...
    2808:	3dc080e7          	jalr	988(ra) # 5be0 <exit>
    ...
    2822:	3c2080e7          	jalr	962(ra) # 5be0 <exit>
  close(fd);
    2826:	854a                	mv	a0,s2
  ...
  if(n >= 0){
    ...
    2882:	362080e7          	jalr	866(ra) # 5be0 <exit>
    printf("open(rwsbrk) failed\n");
    ...
    289c:	348080e7          	jalr	840(ra) # 5be0 <exit>
  close(fd);
    28a0:	854a                	mv	a0,s2
  ...
  exit(0);
    ...
    28b0:	334080e7          	jalr	820(ra) # 5be0 <exit>
...
00000000000028b4 <sbrkbasic>:
{
  ...
  pid = fork();
    ...
    28cc:	310080e7          	jalr	784(ra) # 5bd8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2904:	2e0080e7          	jalr	736(ra) # 5be0 <exit>
    ...
    291e:	2c6080e7          	jalr	710(ra) # 5be0 <exit>
      exit(0);
    2922:	4501                	li	a0,0
    2924:	00003097          	auipc	ra,0x3
    2928:	2bc080e7          	jalr	700(ra) # 5be0 <exit>
  wait(&xstatus);
    292c:	fbc40513          	addi	a0,s0,-68
    2930:	00003097          	auipc	ra,0x3
    2934:	2b8080e7          	jalr	696(ra) # 5be8 <wait>
  if(xstatus == 1){
  ...
  for(i = 0; i < 5000; i++){
    ...
    2972:	272080e7          	jalr	626(ra) # 5be0 <exit>
    a = b + 1;
    2976:	84be                	mv	s1,a5
    b = sbrk(1);
    2978:	4505                	li	a0,1
  ...
  pid = fork();
    ...
    2998:	244080e7          	jalr	580(ra) # 5bd8 <fork>
    299c:	892a                	mv	s2,a0
  if(pid < 0){
  ...
  if(c != a + 1){
    ...
    29d4:	210080e7          	jalr	528(ra) # 5be0 <exit>
    ...
    29f6:	1ee080e7          	jalr	494(ra) # 5be0 <exit>
...
0000000000002a3c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b5c:	088080e7          	jalr	136(ra) # 5be0 <exit>
    ...
    2b78:	06c080e7          	jalr	108(ra) # 5be0 <exit>
    ...
    2b98:	04c080e7          	jalr	76(ra) # 5be0 <exit>
    ...
    2bb8:	02c080e7          	jalr	44(ra) # 5be0 <exit>
    ...
    2bd4:	010080e7          	jalr	16(ra) # 5be0 <exit>
    ...
    2bf4:	ff0080e7          	jalr	-16(ra) # 5be0 <exit>
...
0000000000002bf8 <sbrkarg>:
{
  ...
  if(pipe((int *) a) != 0){
    ...
    2c94:	f50080e7          	jalr	-176(ra) # 5be0 <exit>
    ...
    2cb0:	f34080e7          	jalr	-204(ra) # 5be0 <exit>
    printf("%s: pipe() failed\n", s);
    2cb4:	85ce                	mv	a1,s3
    ...
    2ccc:	f18080e7          	jalr	-232(ra) # 5be0 <exit>
...
0000000000002cd0 <argptest>:
{
  ...
  close(fd);
    ...
    2d3e:	ea6080e7          	jalr	-346(ra) # 5be0 <exit>
...
0000000000002d42 <sbrkbugs>:
{
  ...
  int pid = fork();
    ...
    2d4e:	e8e080e7          	jalr	-370(ra) # 5bd8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2d72:	e72080e7          	jalr	-398(ra) # 5be0 <exit>
    printf("fork failed\n");
    ...
    2d8c:	e58080e7          	jalr	-424(ra) # 5be0 <exit>
  wait(0);
    2d90:	4501                	li	a0,0
    2d92:	00003097          	auipc	ra,0x3
    2d96:	e56080e7          	jalr	-426(ra) # 5be8 <wait>
  pid = fork();
    2d9a:	00003097          	auipc	ra,0x3
    2d9e:	e3e080e7          	jalr	-450(ra) # 5bd8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2dc8:	e1c080e7          	jalr	-484(ra) # 5be0 <exit>
    printf("fork failed\n");
    ...
    2de2:	e02080e7          	jalr	-510(ra) # 5be0 <exit>
  wait(0);
    2de6:	4501                	li	a0,0
    2de8:	00003097          	auipc	ra,0x3
    2dec:	e00080e7          	jalr	-512(ra) # 5be8 <wait>
  pid = fork();
    2df0:	00003097          	auipc	ra,0x3
    2df4:	de8080e7          	jalr	-536(ra) # 5bd8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2e28:	dbc080e7          	jalr	-580(ra) # 5be0 <exit>
    printf("fork failed\n");
    ...
    2e42:	da2080e7          	jalr	-606(ra) # 5be0 <exit>
  wait(0);
    2e46:	4501                	li	a0,0
    2e48:	00003097          	auipc	ra,0x3
    2e4c:	da0080e7          	jalr	-608(ra) # 5be8 <wait>
  exit(0);
    2e50:	4501                	li	a0,0
    2e52:	00003097          	auipc	ra,0x3
    2e56:	d8e080e7          	jalr	-626(ra) # 5be0 <exit>
...
0000000000002e5a <sbrklast>:
{
  ...
  if(p[0] != 'x')
    ...
    2f28:	cbc080e7          	jalr	-836(ra) # 5be0 <exit>
...
0000000000002f62 <execout>:
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    2f7a:	c62080e7          	jalr	-926(ra) # 5bd8 <fork>
    2f7e:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    2f8c:	c60080e7          	jalr	-928(ra) # 5be8 <wait>
  for(int avail = 0; avail < 15; avail++){
  ...
  exit(0);
    ...
    2f9c:	c48080e7          	jalr	-952(ra) # 5be0 <exit>
      printf("fork failed\n");
    ...
    2fb6:	c2e080e7          	jalr	-978(ra) # 5be0 <exit>
        if(a == 0xffffffffffffffffLL)
    2fba:	59fd                	li	s3,-1
        *(char*)(a + 4096 - 1) = 1;
    2fbc:	4a05                	li	s4,1
    ...
    3022:	bc2080e7          	jalr	-1086(ra) # 5be0 <exit>
...
0000000000003026 <fourteen>:
{
  ...
  unlink("12345678901234");
    ...
    313a:	aaa080e7          	jalr	-1366(ra) # 5be0 <exit>
    ...
    3156:	a8e080e7          	jalr	-1394(ra) # 5be0 <exit>
    ...
    3172:	a72080e7          	jalr	-1422(ra) # 5be0 <exit>
    ...
    318e:	a56080e7          	jalr	-1450(ra) # 5be0 <exit>
    ...
    31aa:	a3a080e7          	jalr	-1478(ra) # 5be0 <exit>
    ...
    31c6:	a1e080e7          	jalr	-1506(ra) # 5be0 <exit>
...
000000000000340a <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    3488:	75c080e7          	jalr	1884(ra) # 5be0 <exit>
    ...
    34a4:	740080e7          	jalr	1856(ra) # 5be0 <exit>
    ...
    34c0:	724080e7          	jalr	1828(ra) # 5be0 <exit>
    ...
    34dc:	708080e7          	jalr	1800(ra) # 5be0 <exit>
...
00000000000034e0 <exitiputtest>:
{
  ...
  pid = fork();
    ...
    34f0:	6ec080e7          	jalr	1772(ra) # 5bd8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    353c:	6a8080e7          	jalr	1704(ra) # 5be0 <exit>
    printf("%s: fork failed\n", s);
    3540:	85a6                	mv	a1,s1
    ...
    3558:	68c080e7          	jalr	1676(ra) # 5be0 <exit>
      printf("%s: mkdir failed\n", s);
    355c:	85a6                	mv	a1,s1
    ...
    3574:	670080e7          	jalr	1648(ra) # 5be0 <exit>
    ...
    3590:	654080e7          	jalr	1620(ra) # 5be0 <exit>
      printf("%s: unlink ../iputdir failed\n", s);
    3594:	85a6                	mv	a1,s1
    ...
    35ac:	638080e7          	jalr	1592(ra) # 5be0 <exit>
  wait(&xstatus);
    35b0:	fdc40513          	addi	a0,s0,-36
    35b4:	00002097          	auipc	ra,0x2
    35b8:	634080e7          	jalr	1588(ra) # 5be8 <wait>
  exit(xstatus);
    35bc:	fdc42503          	lw	a0,-36(s0)
    35c0:	00002097          	auipc	ra,0x2
    35c4:	620080e7          	jalr	1568(ra) # 5be0 <exit>
...
00000000000035c8 <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    3646:	59e080e7          	jalr	1438(ra) # 5be0 <exit>
    ...
    3662:	582080e7          	jalr	1410(ra) # 5be0 <exit>
    printf("%s: chdir .. failed\n", s);
    3666:	85a6                	mv	a1,s1
    ...
    367e:	566080e7          	jalr	1382(ra) # 5be0 <exit>
    ...
    369a:	54a080e7          	jalr	1354(ra) # 5be0 <exit>
...
000000000000369e <subdir>:
{
  ...
  if(unlink("dd") < 0){
    ...
    3a70:	174080e7          	jalr	372(ra) # 5be0 <exit>
    ...
    3a8c:	158080e7          	jalr	344(ra) # 5be0 <exit>
    ...
    3aa8:	13c080e7          	jalr	316(ra) # 5be0 <exit>
    ...
    3ac4:	120080e7          	jalr	288(ra) # 5be0 <exit>
    ...
    3ae0:	104080e7          	jalr	260(ra) # 5be0 <exit>
    ...
    3afc:	0e8080e7          	jalr	232(ra) # 5be0 <exit>
    ...
    3b18:	0cc080e7          	jalr	204(ra) # 5be0 <exit>
    ...
    3b34:	0b0080e7          	jalr	176(ra) # 5be0 <exit>
    ...
    3b50:	094080e7          	jalr	148(ra) # 5be0 <exit>
    ...
    3b6c:	078080e7          	jalr	120(ra) # 5be0 <exit>
    ...
    3b88:	05c080e7          	jalr	92(ra) # 5be0 <exit>
    ...
    3ba4:	040080e7          	jalr	64(ra) # 5be0 <exit>
    ...
    3bc0:	024080e7          	jalr	36(ra) # 5be0 <exit>
    printf("%s: chdir ./.. failed\n", s);
    3bc4:	85ca                	mv	a1,s2
    ...
    3bdc:	008080e7          	jalr	8(ra) # 5be0 <exit>
    ...
    3bf8:	fec080e7          	jalr	-20(ra) # 5be0 <exit>
    ...
    3c14:	fd0080e7          	jalr	-48(ra) # 5be0 <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded!\n", s);
    3c18:	85ca                	mv	a1,s2
    ...
    3c30:	fb4080e7          	jalr	-76(ra) # 5be0 <exit>
    ...
    3c4c:	f98080e7          	jalr	-104(ra) # 5be0 <exit>
    ...
    3c68:	f7c080e7          	jalr	-132(ra) # 5be0 <exit>
    ...
    3c84:	f60080e7          	jalr	-160(ra) # 5be0 <exit>
    ...
    3ca0:	f44080e7          	jalr	-188(ra) # 5be0 <exit>
    ...
    3cbc:	f28080e7          	jalr	-216(ra) # 5be0 <exit>
    ...
    3cd8:	f0c080e7          	jalr	-244(ra) # 5be0 <exit>
    ...
    3cf4:	ef0080e7          	jalr	-272(ra) # 5be0 <exit>
    ...
    3d10:	ed4080e7          	jalr	-300(ra) # 5be0 <exit>
    ...
    3d2c:	eb8080e7          	jalr	-328(ra) # 5be0 <exit>
    ...
    3d48:	e9c080e7          	jalr	-356(ra) # 5be0 <exit>
    ...
    3d64:	e80080e7          	jalr	-384(ra) # 5be0 <exit>
    ...
    3d80:	e64080e7          	jalr	-412(ra) # 5be0 <exit>
    ...
    3d9c:	e48080e7          	jalr	-440(ra) # 5be0 <exit>
    ...
    3db8:	e2c080e7          	jalr	-468(ra) # 5be0 <exit>
    ...
    3dd4:	e10080e7          	jalr	-496(ra) # 5be0 <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    3dd8:	85ca                	mv	a1,s2
    ...
    3df0:	df4080e7          	jalr	-524(ra) # 5be0 <exit>
    ...
    3e0c:	dd8080e7          	jalr	-552(ra) # 5be0 <exit>
    ...
    3e28:	dbc080e7          	jalr	-580(ra) # 5be0 <exit>
    ...
    3e44:	da0080e7          	jalr	-608(ra) # 5be0 <exit>
    ...
    3e60:	d84080e7          	jalr	-636(ra) # 5be0 <exit>
...
0000000000003e64 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    3f22:	cc2080e7          	jalr	-830(ra) # 5be0 <exit>
    ...
    3f3e:	ca6080e7          	jalr	-858(ra) # 5be0 <exit>
    printf("%s: rm . worked!\n", s);
    3f42:	85a6                	mv	a1,s1
    ...
    3f5a:	c8a080e7          	jalr	-886(ra) # 5be0 <exit>
    printf("%s: rm .. worked!\n", s);
    3f5e:	85a6                	mv	a1,s1
    ...
    3f76:	c6e080e7          	jalr	-914(ra) # 5be0 <exit>
    printf("%s: chdir / failed\n", s);
    3f7a:	85a6                	mv	a1,s1
    ...
    3f92:	c52080e7          	jalr	-942(ra) # 5be0 <exit>
    ...
    3fae:	c36080e7          	jalr	-970(ra) # 5be0 <exit>
    printf("%s: unlink dots/.. worked!\n", s);
    3fb2:	85a6                	mv	a1,s1
    ...
    3fca:	c1a080e7          	jalr	-998(ra) # 5be0 <exit>
    ...
    3fe6:	bfe080e7          	jalr	-1026(ra) # 5be0 <exit>
...
0000000000003fea <dirfile>:
{
  ...
  close(fd);
    ...
    411e:	ac6080e7          	jalr	-1338(ra) # 5be0 <exit>
    ...
    413a:	aaa080e7          	jalr	-1366(ra) # 5be0 <exit>
    ...
    4156:	a8e080e7          	jalr	-1394(ra) # 5be0 <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    415a:	85ca                	mv	a1,s2
    ...
    4172:	a72080e7          	jalr	-1422(ra) # 5be0 <exit>
    ...
    418e:	a56080e7          	jalr	-1450(ra) # 5be0 <exit>
    ...
    41aa:	a3a080e7          	jalr	-1478(ra) # 5be0 <exit>
    ...
    41c6:	a1e080e7          	jalr	-1506(ra) # 5be0 <exit>
    ...
    41e2:	a02080e7          	jalr	-1534(ra) # 5be0 <exit>
    ...
    41fe:	9e6080e7          	jalr	-1562(ra) # 5be0 <exit>
    ...
    421a:	9ca080e7          	jalr	-1590(ra) # 5be0 <exit>
...
000000000000421e <iref>:
{
    ...
    4272:	972080e7          	jalr	-1678(ra) # 5be0 <exit>
    ...
    428e:	956080e7          	jalr	-1706(ra) # 5be0 <exit>
      close(fd);
...
0000000000004358 <openiputtest>:
{
  ...
  pid = fork();
    ...
    437c:	860080e7          	jalr	-1952(ra) # 5bd8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    43b4:	830080e7          	jalr	-2000(ra) # 5be0 <exit>
    ...
    43d0:	814080e7          	jalr	-2028(ra) # 5be0 <exit>
    printf("%s: fork failed\n", s);
    43d4:	85a6                	mv	a1,s1
    ...
    43ec:	7f8080e7          	jalr	2040(ra) # 5be0 <exit>
    exit(0);
    43f0:	4501                	li	a0,0
    43f2:	00001097          	auipc	ra,0x1
    43f6:	7ee080e7          	jalr	2030(ra) # 5be0 <exit>
  sleep(1);
    43fa:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    442e:	7b6080e7          	jalr	1974(ra) # 5be0 <exit>
  wait(&xstatus);
    4432:	fdc40513          	addi	a0,s0,-36
    4436:	00001097          	auipc	ra,0x1
    443a:	7b2080e7          	jalr	1970(ra) # 5be8 <wait>
  exit(xstatus);
    443e:	fdc42503          	lw	a0,-36(s0)
    4442:	00001097          	auipc	ra,0x1
    4446:	79e080e7          	jalr	1950(ra) # 5be0 <exit>
...
000000000000444a <forkforkfork>:
{
  ...
  int pid = fork();
    ...
    446a:	772080e7          	jalr	1906(ra) # 5bd8 <fork>
  if(pid < 0){
  ...
  wait(0);
    ...
    44a0:	74c080e7          	jalr	1868(ra) # 5be8 <wait>
  sleep(10); // one second
    44a4:	4529                	li	a0,10
    ...
    44d0:	714080e7          	jalr	1812(ra) # 5be0 <exit>
    ...
    44f0:	6ec080e7          	jalr	1772(ra) # 5bd8 <fork>
    ...
    4516:	6ce080e7          	jalr	1742(ra) # 5be0 <exit>
...
000000000000451a <killstatus>:
{
    ...
    4536:	6a6080e7          	jalr	1702(ra) # 5bd8 <fork>
    453a:	84aa                	mv	s1,a0
    if(pid1 < 0){
    ...
    455e:	68e080e7          	jalr	1678(ra) # 5be8 <wait>
    if(xst != -1) {
  ...
  exit(0);
    ...
    4576:	66e080e7          	jalr	1646(ra) # 5be0 <exit>
      printf("%s: fork failed\n", s);
    457a:	85d2                	mv	a1,s4
    ...
    4592:	652080e7          	jalr	1618(ra) # 5be0 <exit>
        getpid();
    ...
    45b8:	62c080e7          	jalr	1580(ra) # 5be0 <exit>
...
00000000000045bc <preempt>:
{
  ...
  pid1 = fork();
    ...
    45d2:	60a080e7          	jalr	1546(ra) # 5bd8 <fork>
  if(pid1 < 0) {
  ...
  if(pid1 == 0)
    ...
    45f8:	5ec080e7          	jalr	1516(ra) # 5be0 <exit>
  pid2 = fork();
    45fc:	00001097          	auipc	ra,0x1
    4600:	5dc080e7          	jalr	1500(ra) # 5bd8 <fork>
    4604:	89aa                	mv	s3,a0
  if(pid2 < 0) {
  ...
  if(pid2 == 0)
    ...
    4626:	5be080e7          	jalr	1470(ra) # 5be0 <exit>
  pipe(pfds);
  ...
  pid3 = fork();
    ...
    463a:	5a2080e7          	jalr	1442(ra) # 5bd8 <fork>
    463e:	892a                	mv	s2,a0
  if(pid3 < 0) {
  ...
  if(pid3 == 0){
    ...
    4694:	550080e7          	jalr	1360(ra) # 5be0 <exit>
  ...
  wait(0);
    ...
    4746:	4a6080e7          	jalr	1190(ra) # 5be8 <wait>
  wait(0);
    474a:	4501                	li	a0,0
    474c:	00001097          	auipc	ra,0x1
    4750:	49c080e7          	jalr	1180(ra) # 5be8 <wait>
  wait(0);
    4754:	4501                	li	a0,0
    4756:	00001097          	auipc	ra,0x1
    475a:	492080e7          	jalr	1170(ra) # 5be8 <wait>
...
0000000000004760 <reparent>:
{
  ...
  int master_pid = getpid();
    ...
    4784:	458080e7          	jalr	1112(ra) # 5bd8 <fork>
    4788:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    4796:	456080e7          	jalr	1110(ra) # 5be8 <wait>
  ...
  exit(0);
    ...
    47aa:	43a080e7          	jalr	1082(ra) # 5be0 <exit>
      printf("%s: fork failed\n", s);
    47ae:	85ce                	mv	a1,s3
    ...
    47c6:	41e080e7          	jalr	1054(ra) # 5be0 <exit>
        printf("%s: wait wrong pid\n", s);
    47ca:	85ce                	mv	a1,s3
    ...
    47e2:	402080e7          	jalr	1026(ra) # 5be0 <exit>
      int pid2 = fork();
    47e6:	00001097          	auipc	ra,0x1
    47ea:	3f2080e7          	jalr	1010(ra) # 5bd8 <fork>
      if(pid2 < 0){
    47ee:	00054763          	bltz	a0,47fc <reparent+0x9c>
      exit(0);
    47f2:	4501                	li	a0,0
    47f4:	00001097          	auipc	ra,0x1
    47f8:	3ec080e7          	jalr	1004(ra) # 5be0 <exit>
        kill(master_pid);
    47fc:	8552                	mv	a0,s4
    ...
    480c:	3d8080e7          	jalr	984(ra) # 5be0 <exit>
...
0000000000004810 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4858:	38c080e7          	jalr	908(ra) # 5be0 <exit>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    48a4:	338080e7          	jalr	824(ra) # 5bd8 <fork>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    48f0:	2fc080e7          	jalr	764(ra) # 5be8 <wait>
  ...
  pid = fork();
    ...
    4900:	2dc080e7          	jalr	732(ra) # 5bd8 <fork>
    4904:	84aa                	mv	s1,a0
  if(pid < 0){
  ...
  wait(&xstatus);
    ...
    4914:	2d8080e7          	jalr	728(ra) # 5be8 <wait>
  if(xstatus != -1 && xstatus != 2)
    ...
    4952:	292080e7          	jalr	658(ra) # 5be0 <exit>
    printf("%s: fork failed\n", s);
    4956:	85ca                	mv	a1,s2
    ...
    496e:	276080e7          	jalr	630(ra) # 5be0 <exit>
    a = sbrk(0);
    4972:	4501                	li	a0,0
    ...
    49ba:	22a080e7          	jalr	554(ra) # 5be0 <exit>
    exit(1);
    49be:	4505                	li	a0,1
    49c0:	00001097          	auipc	ra,0x1
    49c4:	220080e7          	jalr	544(ra) # 5be0 <exit>
...
00000000000049c8 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    49dc:	200080e7          	jalr	512(ra) # 5bd8 <fork>
    m1 = 0;
    49e0:	4481                	li	s1,0
  ...
  if((pid = fork()) == 0){
    ...
    4a26:	1be080e7          	jalr	446(ra) # 5be0 <exit>
    ...
    4a42:	1a2080e7          	jalr	418(ra) # 5be0 <exit>
    wait(&xstatus);
    4a46:	fcc40513          	addi	a0,s0,-52
    4a4a:	00001097          	auipc	ra,0x1
    4a4e:	19e080e7          	jalr	414(ra) # 5be8 <wait>
    if(xstatus == -1){
    ...
    4a60:	184080e7          	jalr	388(ra) # 5be0 <exit>
      exit(0);
    4a64:	4501                	li	a0,0
    4a66:	00001097          	auipc	ra,0x1
    4a6a:	17a080e7          	jalr	378(ra) # 5be0 <exit>
...
0000000000004a6e <sharedfd>:
{
  ...
  pid = fork();
    ...
    4ab4:	128080e7          	jalr	296(ra) # 5bd8 <fork>
    4ab8:	89aa                	mv	s3,a0
  ...
  if(pid == 0) {
    ...
    4afa:	0ea080e7          	jalr	234(ra) # 5be0 <exit>
    ...
    4b16:	0ce080e7          	jalr	206(ra) # 5be0 <exit>
    ...
    4b32:	0b2080e7          	jalr	178(ra) # 5be0 <exit>
    wait(&xstatus);
    4b36:	f9c40513          	addi	a0,s0,-100
    4b3a:	00001097          	auipc	ra,0x1
    4b3e:	0ae080e7          	jalr	174(ra) # 5be8 <wait>
    if(xstatus != 0)
    ...
    4b50:	094080e7          	jalr	148(ra) # 5be0 <exit>
  close(fd);
    4b54:	854a                	mv	a0,s2
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4bb6:	02e080e7          	jalr	46(ra) # 5be0 <exit>
        nc++;
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c18:	fcc080e7          	jalr	-52(ra) # 5be0 <exit>
    exit(0);
    4c1c:	4501                	li	a0,0
    4c1e:	00001097          	auipc	ra,0x1
    4c22:	fc2080e7          	jalr	-62(ra) # 5be0 <exit>
...
0000000000004c26 <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4c92:	f4a080e7          	jalr	-182(ra) # 5bd8 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4cae:	f3e080e7          	jalr	-194(ra) # 5be8 <wait>
    if(xstatus != 0)
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cf8:	eec080e7          	jalr	-276(ra) # 5be0 <exit>
    ...
    4d56:	e8e080e7          	jalr	-370(ra) # 5be0 <exit>
    ...
    4d72:	e72080e7          	jalr	-398(ra) # 5be0 <exit>
    ...
    4d8c:	e58080e7          	jalr	-424(ra) # 5be0 <exit>
      exit(xstatus);
    4d90:	00001097          	auipc	ra,0x1
    4d94:	e50080e7          	jalr	-432(ra) # 5be0 <exit>
          printf("wrong char\n", s);
    4d98:	85e6                	mv	a1,s9
    ...
    4db0:	e34080e7          	jalr	-460(ra) # 5be0 <exit>
      total += n;
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e40:	da4080e7          	jalr	-604(ra) # 5be0 <exit>
}
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4ee4:	d00080e7          	jalr	-768(ra) # 5be0 <exit>
      link("C0", file);
    ...
    4f02:	ce2080e7          	jalr	-798(ra) # 5be0 <exit>
        exit(1);
    4f06:	4505                	li	a0,1
    4f08:	00001097          	auipc	ra,0x1
    4f0c:	cd8080e7          	jalr	-808(ra) # 5be0 <exit>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f60:	c84080e7          	jalr	-892(ra) # 5be0 <exit>
      fa[i] = 1;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4fd0:	c14080e7          	jalr	-1004(ra) # 5be0 <exit>
  close(fd);
    4fd4:	854a                	mv	a0,s2
  ...
  for(i = 0; i < N; i++){
    ...
    5008:	bdc080e7          	jalr	-1060(ra) # 5be0 <exit>
      printf("%s: fork failed\n", s);
    500c:	85ce                	mv	a1,s3
    ...
    5024:	bc0080e7          	jalr	-1088(ra) # 5be0 <exit>
      close(open(file, 0));
    5028:	4581                	li	a1,0
    ...
    50b6:	b36080e7          	jalr	-1226(ra) # 5be8 <wait>
  for(i = 0; i < N; i++){
    ...
    50cc:	b10080e7          	jalr	-1264(ra) # 5bd8 <fork>
    50d0:	892a                	mv	s2,a0
    if(pid < 0){
    ...
    5138:	aac080e7          	jalr	-1364(ra) # 5be0 <exit>
      close(fd);
    ...
    5156:	a96080e7          	jalr	-1386(ra) # 5be8 <wait>
      if(xstatus != 0)
  ...
  for(i = 0; i < N; i++){
    ...
    5180:	a5c080e7          	jalr	-1444(ra) # 5bd8 <fork>
    if(pid && (i % 3) == 1){
...
00000000000051bc <bigfile>:
{
  ...
  for(i = 0; ; i++){
    ...
    52ba:	92a080e7          	jalr	-1750(ra) # 5be0 <exit>
    ...
    52d6:	90e080e7          	jalr	-1778(ra) # 5be0 <exit>
    ...
    52f2:	8f2080e7          	jalr	-1806(ra) # 5be0 <exit>
    ...
    530e:	8d6080e7          	jalr	-1834(ra) # 5be0 <exit>
    ...
    532a:	8ba080e7          	jalr	-1862(ra) # 5be0 <exit>
    ...
    5346:	89e080e7          	jalr	-1890(ra) # 5be0 <exit>
  close(fd);
    534a:	8552                	mv	a0,s4
  ...
  unlink("bigfile.dat");
    ...
    5398:	84c080e7          	jalr	-1972(ra) # 5be0 <exit>
...
run(void f(char *), char *s) {
  ...
  if((pid = fork()) < 0) {
    ...
    5560:	67c080e7          	jalr	1660(ra) # 5bd8 <fork>
  ...
  if(pid == 0) {
    ...
    5572:	67a080e7          	jalr	1658(ra) # 5be8 <wait>
    if(xstatus != 0) 
    ...
    55b6:	62e080e7          	jalr	1582(ra) # 5be0 <exit>
    f(s);
    55ba:	854a                	mv	a0,s2
    55bc:	9482                	jalr	s1
    exit(0);
    ...
    55c4:	620080e7          	jalr	1568(ra) # 5be0 <exit>
      printf("OK\n");
...
countfree()
{
  ...
  int pid = fork();
    ...
    5658:	584080e7          	jalr	1412(ra) # 5bd8 <fork>
  ...
  if(pid == 0){
    ...
    56bc:	528080e7          	jalr	1320(ra) # 5be0 <exit>
    printf("pipe() failed in countfree()\n");
    ...
    56d6:	50e080e7          	jalr	1294(ra) # 5be0 <exit>
    printf("fork failed in countfree()\n");
    ...
    56f0:	4f4080e7          	jalr	1268(ra) # 5be0 <exit>
      }
    }
    ...
    56fa:	4ea080e7          	jalr	1258(ra) # 5be0 <exit>
  }
  ...
  while(1){
    ...
    573e:	4a6080e7          	jalr	1190(ra) # 5be0 <exit>
  }
  ...
  wait((int*)0);
    ...
    5754:	498080e7          	jalr	1176(ra) # 5be8 <wait>
...
main(int argc, char *argv[])
{
  ...
  if (drivetests(quick, continuous, justone)) {
    ...
    589c:	348080e7          	jalr	840(ra) # 5be0 <exit>
    58a0:	892e                	mv	s2,a1
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
  ...
  int continuous = 0;
    ...
    5910:	2d4080e7          	jalr	724(ra) # 5be0 <exit>
  int continuous = 0;
    5914:	84aa                	mv	s1,a0
  char *justone = 0;
    5916:	4601                	li	a2,0
  ...
  exit(0);
    ...
    593c:	2a8080e7          	jalr	680(ra) # 5be0 <exit>
...
_main()
{
  ...
  exit(0);
    ...
    5956:	28e080e7          	jalr	654(ra) # 5be0 <exit>
...
ugetpid(void)
{
  ...
  return u->pid;
    ...
    5bce:	00002503          	lw	a0,0(zero) # 0 <copyinstr1>
    5bd2:	6422                	ld	s0,8(sp)
    5bd4:	0141                	addi	sp,sp,16
    5bd6:	8082                	ret

0000000000005bd8 <fork>:
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5ca6:	f5e080e7          	jalr	-162(ra) # 5c00 <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    60fe:	b6e080e7          	jalr	-1170(ra) # 5c68 <sbrk>
  if(p == (char*)-1)
