...
go(int which_child)
{
  ...
  if(chdir("grindir") != 0){
    ...
    exit(1);
      ...
      d2:	dde080e7          	jalr	-546(ra) # eac <exit>
  }
  chdir("/");
  ...
  int fd = -1;
    ...
    if(what == 1){
     ...
     1f2:	cb6080e7          	jalr	-842(ra) # ea4 <fork>
      if(pid1 == 0){
     ...
     202:	ca6080e7          	jalr	-858(ra) # ea4 <fork>
      if(pid2 == 0){
     ...
     280:	c38080e7          	jalr	-968(ra) # eb4 <wait>
      wait(&st2);
     284:	fa840513          	addi	a0,s0,-88
     288:	00001097          	auipc	ra,0x1
     28c:	c2c080e7          	jalr	-980(ra) # eb4 <wait>
     ...
     2d8:	bd8080e7          	jalr	-1064(ra) # eac <exit>
     ...
     356:	b5a080e7          	jalr	-1190(ra) # eac <exit>
      close(fd);
     35a:	854a                	mv	a0,s2
     ...
     496:	a12080e7          	jalr	-1518(ra) # ea4 <fork>
      if(pid == 0){
     ...
     4a6:	a12080e7          	jalr	-1518(ra) # eb4 <wait>
     4aa:	b9a5                	j	122 <go+0xaa>
        exit(0);
     4ac:	00001097          	auipc	ra,0x1
     4b0:	a00080e7          	jalr	-1536(ra) # eac <exit>
        printf("grind: fork failed\n");
     ...
     4ca:	9e6080e7          	jalr	-1562(ra) # eac <exit>
      int pid = fork();
     4ce:	00001097          	auipc	ra,0x1
     4d2:	9d6080e7          	jalr	-1578(ra) # ea4 <fork>
      if(pid == 0){
     ...
     4e2:	9d6080e7          	jalr	-1578(ra) # eb4 <wait>
     4e6:	b935                	j	122 <go+0xaa>
        fork();
     4e8:	00001097          	auipc	ra,0x1
     4ec:	9bc080e7          	jalr	-1604(ra) # ea4 <fork>
        fork();
     4f0:	00001097          	auipc	ra,0x1
     4f4:	9b4080e7          	jalr	-1612(ra) # ea4 <fork>
        exit(0);
     4f8:	4501                	li	a0,0
     4fa:	00001097          	auipc	ra,0x1
     4fe:	9b2080e7          	jalr	-1614(ra) # eac <exit>
        printf("grind: fork failed\n");
     ...
     518:	998080e7          	jalr	-1640(ra) # eac <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     ...
     556:	952080e7          	jalr	-1710(ra) # ea4 <fork>
     55a:	8b2a                	mv	s6,a0
      if(pid == 0){
     ...
     584:	934080e7          	jalr	-1740(ra) # eb4 <wait>
     ...
     5ac:	904080e7          	jalr	-1788(ra) # eac <exit>
        printf("grind: fork failed\n");
     ...
     5c6:	8ea080e7          	jalr	-1814(ra) # eac <exit>
        printf("grind: chdir failed\n");
     ...
     5e0:	8d0080e7          	jalr	-1840(ra) # eac <exit>
      int pid = fork();
     5e4:	00001097          	auipc	ra,0x1
     5e8:	8c0080e7          	jalr	-1856(ra) # ea4 <fork>
      if(pid == 0){
     ...
     5f8:	8c0080e7          	jalr	-1856(ra) # eb4 <wait>
     ...
     614:	89c080e7          	jalr	-1892(ra) # eac <exit>
        printf("grind: fork failed\n");
     ...
     62e:	882080e7          	jalr	-1918(ra) # eac <exit>
      if(pipe(fds) < 0){
     ...
     646:	862080e7          	jalr	-1950(ra) # ea4 <fork>
      if(pid == 0){
     ...
     66e:	84a080e7          	jalr	-1974(ra) # eb4 <wait>
     ...
     68a:	826080e7          	jalr	-2010(ra) # eac <exit>
        fork();
     68e:	00001097          	auipc	ra,0x1
     692:	816080e7          	jalr	-2026(ra) # ea4 <fork>
        fork();
     696:	00001097          	auipc	ra,0x1
     69a:	80e080e7          	jalr	-2034(ra) # ea4 <fork>
     ...
     6d8:	7d8080e7          	jalr	2008(ra) # eac <exit>
     ...
     716:	79a080e7          	jalr	1946(ra) # eac <exit>
      int pid = fork();
     71a:	00000097          	auipc	ra,0x0
     71e:	78a080e7          	jalr	1930(ra) # ea4 <fork>
      if(pid == 0){
     ...
     72e:	78a080e7          	jalr	1930(ra) # eb4 <wait>
     ...
     79e:	712080e7          	jalr	1810(ra) # eac <exit>
        printf("grind: fork failed\n");
     ...
     7b8:	6f8080e7          	jalr	1784(ra) # eac <exit>
      unlink("c");
     ...
     856:	65a080e7          	jalr	1626(ra) # eac <exit>
     ...
     870:	640080e7          	jalr	1600(ra) # eac <exit>
     ...
     88a:	626080e7          	jalr	1574(ra) # eac <exit>
     ...
     8a6:	60a080e7          	jalr	1546(ra) # eac <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     ...
     8c0:	5f0080e7          	jalr	1520(ra) # eac <exit>
        fprintf(2, "grind: pipe failed\n");
     ...
     8dc:	5d4080e7          	jalr	1492(ra) # eac <exit>
        fprintf(2, "grind: pipe failed\n");
     ...
     8f8:	5b8080e7          	jalr	1464(ra) # eac <exit>
        close(bb[0]);
     ...
     954:	55c080e7          	jalr	1372(ra) # eac <exit>
        close(aa[1]);
     ...
     9ac:	504080e7          	jalr	1284(ra) # eac <exit>
        fprintf(2, "grind: fork failed\n");
     ...
     9c8:	4e8080e7          	jalr	1256(ra) # eac <exit>
        close(aa[1]);
     ...
     a14:	49c080e7          	jalr	1180(ra) # eac <exit>
        close(aa[0]);
     ...
     a58:	458080e7          	jalr	1112(ra) # eac <exit>
        close(bb[1]);
     ...
     aa4:	40c080e7          	jalr	1036(ra) # eac <exit>
        fprintf(2, "grind: fork failed\n");
     ...
     ac0:	3f0080e7          	jalr	1008(ra) # eac <exit>
...
iter()
{
  ...
  int pid1 = fork();
     ...
     af4:	3b4080e7          	jalr	948(ra) # ea4 <fork>
  if(pid1 < 0){
  ...
  if(pid1 == 0){
    ...
    exit(1);
     ...
     b30:	380080e7          	jalr	896(ra) # eac <exit>
    exit(0);
  }

  int pid2 = fork();
     b34:	00000097          	auipc	ra,0x0
     b38:	370080e7          	jalr	880(ra) # ea4 <fork>
     b3c:	892a                	mv	s2,a0
  if(pid2 < 0){
  ...
  if(pid2 == 0){
    ...
    exit(1);
     ...
     b78:	338080e7          	jalr	824(ra) # eac <exit>
    exit(0);
  }
  ...
  wait(&st1);
     ...
     b8a:	32e080e7          	jalr	814(ra) # eb4 <wait>
  if(st1 != 0){
  ...
  wait(&st2);
     ...
     ba2:	316080e7          	jalr	790(ra) # eb4 <wait>

  exit(0);
     ba6:	4501                	li	a0,0
     ba8:	00000097          	auipc	ra,0x0
     bac:	304080e7          	jalr	772(ra) # eac <exit>
    kill(pid1);
     bb0:	8526                	mv	a0,s1
...
main()
{
    ...
    int pid = fork();
     ...
     bf6:	2b2080e7          	jalr	690(ra) # ea4 <fork>
    if(pid == 0){
    ...
    if(pid > 0){
     ...
     c06:	2b2080e7          	jalr	690(ra) # eb4 <wait>
...
ugetpid(void)
{
  ...
  return u->pid;
     ...
     e9a:	00002503          	lw	a0,0(zero) # 0 <do_rand>
     e9e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    13ca:	b6e080e7          	jalr	-1170(ra) # f34 <sbrk>
  if(p == (char*)-1)
