...
int main() 
{
   ...
   6:	1000                	addi	s0,sp,32
    int p[2];
    // 创建管道，p[0]用于读取，p[1]用于写入
     pipe(p);
   8:	fe840513          	addi	a0,s0,-24
   c:	00000097          	auipc	ra,0x0
  10:	346080e7          	jalr	838(ra) # 352 <pipe>

    // 创建子进程
    int pid = fork(); 
  14:	00000097          	auipc	ra,0x0
  18:	326080e7          	jalr	806(ra) # 33a <fork>
  1c:	fea42223          	sw	a0,-28(s0)
   
    // 子进程
    if (!pid) 
  20:	ed1d                	bnez	a0,5e <main+0x5e>
    {
        // 关闭写入端，子进程只需要读取
        close(p[1]); 
  22:	fec42503          	lw	a0,-20(s0)
  26:	00000097          	auipc	ra,0x0
  2a:	344080e7          	jalr	836(ra) # 36a <close>
        // 从管道中读取数据，即父进程的PID
        read(p[0], &pid, sizeof(pid)); 
  2e:	4611                	li	a2,4
  30:	fe440593          	addi	a1,s0,-28
  34:	fe842503          	lw	a0,-24(s0)
  38:	00000097          	auipc	ra,0x0
  3c:	322080e7          	jalr	802(ra) # 35a <read>
        printf("%d: received ping\n", pid);
  40:	fe442583          	lw	a1,-28(s0)
  44:	00001517          	auipc	a0,0x1
  48:	82c50513          	addi	a0,a0,-2004 # 870 <malloc+0xe8>
  4c:	00000097          	auipc	ra,0x0
  50:	67e080e7          	jalr	1662(ra) # 6ca <printf>
        close(p[0]);
        write(p[1], &pid, sizeof(pid)); // 将父进程的PID写入管道
        wait(0); // 等待子进程结束
  ...
  5a:	2ec080e7          	jalr	748(ra) # 342 <exit>
        close(p[0]);
  5e:	fe842503          	lw	a0,-24(s0)
  62:	00000097          	auipc	ra,0x0
  66:	308080e7          	jalr	776(ra) # 36a <close>
        write(p[1], &pid, sizeof(pid)); // 将父进程的PID写入管道
  6a:	4611                	li	a2,4
  6c:	fe440593          	addi	a1,s0,-28
  70:	fec42503          	lw	a0,-20(s0)
  74:	00000097          	auipc	ra,0x0
  78:	2ee080e7          	jalr	750(ra) # 362 <write>
        wait(0); // 等待子进程结束
  7c:	4501                	li	a0,0
  7e:	00000097          	auipc	ra,0x0
  82:	2cc080e7          	jalr	716(ra) # 34a <wait>
        printf("%d: received pong\n", getpid());
  86:	00000097          	auipc	ra,0x0
  8a:	33c080e7          	jalr	828(ra) # 3c2 <getpid>
  8e:	85aa                	mv	a1,a0
  90:	00000517          	auipc	a0,0x0
  94:	7f850513          	addi	a0,a0,2040 # 888 <malloc+0x100>
  98:	00000097          	auipc	ra,0x0
  9c:	632080e7          	jalr	1586(ra) # 6ca <printf>
  a0:	bf55                	j	54 <main+0x54>
...
_main()
{
  ...
  b8:	28e080e7          	jalr	654(ra) # 342 <exit>
...
ugetpid(void)
{
 ...
 330:	00002503          	lw	a0,0(zero) # 0 <main>
 334:	6422                	ld	s0,8(sp)
