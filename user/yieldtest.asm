...
user/_yieldtest：     文件格式 elf64-littleriscv


Disassembly of section .text:

0000000000000000 <yieldtest>:
#include "user/user.h"
...
void yieldtest(void) {
  ...
  printf("yield test\n");
   ...
   c:	89850513          	addi	a0,a0,-1896 # 8a0 <nonblock+0x10>
  10:	00000097          	auipc	ra,0x0
  14:	6d8080e7          	jalr	1752(ra) # 6e8 <printf>
  for (int i = 0; i < 3; i++) {
    int pid = fork();
  18:	00000097          	auipc	ra,0x0
  1c:	340080e7          	jalr	832(ra) # 358 <fork>
    if (pid == 0) {
  20:	c52d                	beqz	a0,8a <yieldtest+0x8a>
    int pid = fork();
  22:	00000097          	auipc	ra,0x0
  26:	336080e7          	jalr	822(ra) # 358 <fork>
    if (pid == 0) {
  2a:	cd39                	beqz	a0,88 <yieldtest+0x88>
    int pid = fork();
  2c:	00000097          	auipc	ra,0x0
  30:	32c080e7          	jalr	812(ra) # 358 <fork>
    if (pid == 0) {
  34:	c921                	beqz	a0,84 <yieldtest+0x84>
  ...
  3a:	89250513          	addi	a0,a0,-1902 # 8c8 <nonblock+0x38>
  3e:	00000097          	auipc	ra,0x0
  42:	6aa080e7          	jalr	1706(ra) # 6e8 <printf>
  // yield之后
  // 在单核情况下，调度器应当调度到子进程
  yield();
  46:	00000097          	auipc	ra,0x0
  4a:	3c2080e7          	jalr	962(ra) # 408 <yield>
  printf("parent yield finished\n");
  4e:	00001517          	auipc	a0,0x1
  52:	88a50513          	addi	a0,a0,-1910 # 8d8 <nonblock+0x48>
  56:	00000097          	auipc	ra,0x0
  5a:	692080e7          	jalr	1682(ra) # 6e8 <printf>
  for (int i = 0; i < 3; i++) {
    wait(0);
  5e:	4501                	li	a0,0
  60:	00000097          	auipc	ra,0x0
  64:	308080e7          	jalr	776(ra) # 368 <wait>
  68:	4501                	li	a0,0
  6a:	00000097          	auipc	ra,0x0
  6e:	2fe080e7          	jalr	766(ra) # 368 <wait>
  72:	4501                	li	a0,0
  74:	00000097          	auipc	ra,0x0
  78:	2f4080e7          	jalr	756(ra) # 368 <wait>
  }
}
  7c:	60a2                	ld	ra,8(sp)
  7e:	6402                	ld	s0,0(sp)
  ...
  for (int i = 0; i < 3; i++) {
  84:	4509                	li	a0,2
  86:	a011                	j	8a <yieldtest+0x8a>
  88:	4505                	li	a0,1
      printf("switch to child %d\n", i);
  8a:	85aa                	mv	a1,a0
  8c:	00001517          	auipc	a0,0x1
  90:	82450513          	addi	a0,a0,-2012 # 8b0 <nonblock+0x20>
  94:	00000097          	auipc	ra,0x0
  98:	654080e7          	jalr	1620(ra) # 6e8 <printf>
      exit(0);
  9c:	4501                	li	a0,0
  9e:	00000097          	auipc	ra,0x0
  a2:	2c2080e7          	jalr	706(ra) # 360 <exit>
...
int main(int argc, char *argv[]) {
  ...
  b2:	f52080e7          	jalr	-174(ra) # 0 <yieldtest>
  exit(0);
  b6:	4501                	li	a0,0
...
_main()
{
  ...
  cc:	fde080e7          	jalr	-34(ra) # a6 <main>
  exit(0);
  d0:	4501                	li	a0,0
  d2:	00000097          	auipc	ra,0x0
  d6:	28e080e7          	jalr	654(ra) # 360 <exit>
...
gets(char *buf, int max)
{
 ...
 1cc:	1b0080e7          	jalr	432(ra) # 378 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21e:	186080e7          	jalr	390(ra) # 3a0 <open>
  if(fd < 0)
 ...
 22e:	18e080e7          	jalr	398(ra) # 3b8 <fstat>
 232:	892a                	mv	s2,a0
  close(fd);
 234:	8526                	mv	a0,s1
 236:	00000097          	auipc	ra,0x0
 23a:	152080e7          	jalr	338(ra) # 388 <close>
  return r;
}
 23e:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 34e:	00002503          	lw	a0,0(zero) # 0 <yieldtest>
 352:	6422                	ld	s0,8(sp)
...
putc(int fd, char c)
{
 ...
 426:	f5e080e7          	jalr	-162(ra) # 380 <write>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 524:	3d8b8b93          	addi	s7,s7,984 # 8f8 <digits>
 ...
 664:	29090913          	addi	s2,s2,656 # 8f0 <nonblock+0x60>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 87e:	b6e080e7          	jalr	-1170(ra) # 3e8 <sbrk>
  if(p == (char*)-1)
