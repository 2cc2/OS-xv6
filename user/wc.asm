...
wc(int fd, char *name)
{
  ...
  fa:	340080e7          	jalr	832(ra) # 436 <exit>
...
main(int argc, char *argv[])
{
 ...
 15a:	2e0080e7          	jalr	736(ra) # 436 <exit>
    wc(0, "");
 ...
 176:	2c4080e7          	jalr	708(ra) # 436 <exit>
      printf("wc: cannot open %s\n", argv[i]);
 17a:	608c                	ld	a1,0(s1)
 ...
 192:	2a8080e7          	jalr	680(ra) # 436 <exit>
...
_main()
{
 ...
 1ac:	28e080e7          	jalr	654(ra) # 436 <exit>
...
ugetpid(void)
{
 ...
 424:	00002503          	lw	a0,0(zero) # 0 <wc>
 428:	6422                	ld	s0,8(sp)
...
putc(int fd, char c)
{
 ...
 4fc:	f5e080e7          	jalr	-162(ra) # 456 <write>
}
...
malloc(uint nbytes)
{
 ...
 954:	b6e080e7          	jalr	-1170(ra) # 4be <sbrk>
  if(p == (char*)-1)
