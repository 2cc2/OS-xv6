...
main(void)
{
  ...
  14:	8d050513          	addi	a0,a0,-1840 # 8e0 <malloc+0xee>
  ...
  3c:	8b098993          	addi	s3,s3,-1872 # 8e8 <malloc+0xf6>
    printf("[162120120] start sh through execve.\n");
  40:	00001917          	auipc	s2,0x1
  44:	8c090913          	addi	s2,s2,-1856 # 900 <malloc+0x10e>
    printf("init: starting sh\n");
  48:	854e                	mv	a0,s3
  4a:	00000097          	auipc	ra,0x0
  4e:	6ea080e7          	jalr	1770(ra) # 734 <printf>
    printf("[162120120] start sh through execve.\n");
  52:	854a                	mv	a0,s2
  54:	00000097          	auipc	ra,0x0
  58:	6e0080e7          	jalr	1760(ra) # 734 <printf>
    pid = fork();
  5c:	00000097          	auipc	ra,0x0
  60:	348080e7          	jalr	840(ra) # 3a4 <fork>
  64:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  72:	346080e7          	jalr	838(ra) # 3b4 <wait>
      if(wpid == pid){
  76:	fca489e3          	beq	s1,a0,48 <main+0x48>
  ...
  82:	8e250513          	addi	a0,a0,-1822 # 960 <malloc+0x16e>
  ...
  a0:	84450513          	addi	a0,a0,-1980 # 8e0 <malloc+0xee>
  a4:	00000097          	auipc	ra,0x0
  a8:	350080e7          	jalr	848(ra) # 3f4 <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00001517          	auipc	a0,0x1
  b2:	83250513          	addi	a0,a0,-1998 # 8e0 <malloc+0xee>
  b6:	00000097          	auipc	ra,0x0
  ba:	336080e7          	jalr	822(ra) # 3ec <open>
  be:	b79d                	j	24 <main+0x24>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	86850513          	addi	a0,a0,-1944 # 928 <malloc+0x136>
  c8:	00000097          	auipc	ra,0x0
  cc:	66c080e7          	jalr	1644(ra) # 734 <printf>
      exit(1);
  d0:	4505                	li	a0,1
  d2:	00000097          	auipc	ra,0x0
  d6:	2da080e7          	jalr	730(ra) # 3ac <exit>
      exec("sh", argv);
  da:	00001597          	auipc	a1,0x1
  de:	f2658593          	addi	a1,a1,-218 # 1000 <argv>
  e2:	00001517          	auipc	a0,0x1
  e6:	85e50513          	addi	a0,a0,-1954 # 940 <malloc+0x14e>
  ea:	00000097          	auipc	ra,0x0
  ee:	2fa080e7          	jalr	762(ra) # 3e4 <exec>
      printf("init: exec sh failed\n");
  f2:	00001517          	auipc	a0,0x1
  f6:	85650513          	addi	a0,a0,-1962 # 948 <malloc+0x156>
  fa:	00000097          	auipc	ra,0x0
  fe:	63a080e7          	jalr	1594(ra) # 734 <printf>
      exit(1);
 102:	4505                	li	a0,1
 104:	00000097          	auipc	ra,0x0
 108:	2a8080e7          	jalr	680(ra) # 3ac <exit>
...
_main()
{
 ...
 122:	28e080e7          	jalr	654(ra) # 3ac <exit>
...
ugetpid(void)
{
 ...
 39a:	00002503          	lw	a0,0(zero) # 0 <main>
 39e:	6422                	ld	s0,8(sp)
...
putc(int fd, char c)
{
 ...
 472:	f5e080e7          	jalr	-162(ra) # 3cc <write>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 570:	41cb8b93          	addi	s7,s7,1052 # 988 <digits>
 ...
 6b0:	2d490913          	addi	s2,s2,724 # 980 <malloc+0x18e>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 8ca:	b6e080e7          	jalr	-1170(ra) # 434 <sbrk>
  if(p == (char*)-1)
